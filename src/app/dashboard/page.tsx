...
import DashboardNav  from "../dashboard/dashboardbody/dashboardNav/DashboardNav";
import DashboardBody from "../dashboard/dashboardbody/page";
...
export default function DashboardPage() {
  ...
  // handle rate passed down for nav meter
  // (static approximation — swap for real computed value if needed)
  const handleRate = 68.4;

  return (
    <div className={`${styles.shell} ${navOpen ? styles.navOpen : styles.navClosed}`}>
      {/* ── Sidebar nav ── */}
      <DashboardNav
        isOpen={navOpen}
      ...
      <div className={styles.mobileTopbar}>
        ...
        <span className={styles.mobileBrand}>OrderDesk</span>
      </div>
      ...
      <main className={styles.main}>
        <DashboardBody
          ...
          onMinimumOrdersChange={setMinimumOrders}
        />
      </main>
    </div>
  );
